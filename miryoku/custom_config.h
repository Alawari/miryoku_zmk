...
U_MT(SI_LG(LS(SI_Q)), SI_LG(SI_Q)),     LA(W),     LA(E),     U_MT(LA(LS(R)), LA(R)),     U_MT(LA(LS(T)), LA(T)),     U_MT(LA(LS(SI_Z)), LA(SI_Z)),     U_MT(LA(LS(U)), LA(U)),     U_MT(LA(LS(I)), LA(I)),     U_MT(LA(LS(O)), LA(O)),     U_MT(LA(LS(P)), LA(P)),    \
