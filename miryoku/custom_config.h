...
U_MT(LA(LS(Y)), LA(Y)),     U_MT(LA(LS(X)), LA(X)),     U_MT(LA(LS(C)), LA(C)),     U_MT(LA(LS(V)), LA(V)),     U_MT(LA(LS(B)), LA(B)),     U_MT(LA(LS(N)), LA(N)),     U_MT(LA(LS(M)), LA(M)),     U_MT(LA(SI_SEMI), LA(SI_COMMA)),     U_MT(LA(SI_DOT), LA(SI_COLON)),     U_MT(LA(SI_UNDER), LA(SI_MINUS)),    \
